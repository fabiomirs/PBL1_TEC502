// Importa classes necessárias para leitura de dados e manipulação de rede
import java.io.BufferedReader;
import java.io.InputStreamReader;
import java.net.Socket;

// Define a classe ClienteThread que estende a classe Thread, permitindo execução em paralelo
    ...
    public void run() {
        try {
            ...
            while ((x = reader.readLine()) != null) {
                ...
                System.out.println("Servidor mandou uma mensagem: " + x);
            }
